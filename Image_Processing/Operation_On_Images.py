...
class FaceRecognition:
    ...
    # creating  the folder of the training set
    def create_data_set_folder(self, folder_name=None):
        if not folder_name is None:
            ...
            # if the folder dose not exist make it there
    ...
    # taking the training set images and save it to the folder
        ...
        if self.__is_classifier_existed is True:
            ...
            while True:
                ...
                if ret == True and self.is_recording_enabled:
                    ...
                    cv2.imwrite(token_image_path, self.cropped_image)  # Saves an image to a specified file.
                    self.counter += 1
                    cv2.waitKey(50)
    ...
    def read_users_data_sets(self, users_folder_path):
        ...
        for every_user_name in users_folder_names:
            ...
            for every_image in user_images :
                ...
                if images_extension in self.available_extentions :
                    ...
                    # give every readable image a label
        ...
        face_recognizer.train(self.image_buffer, labels_as_np)  # save every image with it's label
        face_recognizer.save("indvidual_faces.xml")  # make a model of that train

        # save the model so we don't need to train again
    ...
    def start_face_recognision(self):
        ...
        face_recognizer = cv2.face.LBPHFaceRecognizer_create()
        face_recognizer.read("indvidual_faces.xml")  # read the trained model
        ...
        while True:
            ...
            if ret:
                ...
                for x, y, w, h in faces_result:
                    ...
                    # if the result is one from the training image it returns 1
                    if result[0] == 1:
                        qaqa = 'omar'
                        print('omar')
                    else:
